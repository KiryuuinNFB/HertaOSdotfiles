...
-- See https://wiki.hypr.land/Configuring/Advanced-and-Cool/Environment-variables/la
...
hl.curve("invincible",
         {type = "spring", mass = 1, stiffness = 70, dampening = 1})
...
if hl.plugin.darkwindow ~= nil then
    hl.plugin.darkwindow.load_shader("frosted", {
        from = "chromakey",
        args = "bkg = [0.118 0.118 0.18] amount = 0.1 similarity = 0.5"
